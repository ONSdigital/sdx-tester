...
class TestSetup(unittest.TestCase):
    ...
    def test_insert_comments(self):
        ...
        survey_017.update(
            {
                "created": str(yesterday),
                "encrypted_data": encrypt_comment(
                    {'ru_ref': '34650525171T', 'boxes_selected': '', 'comment': 'I am a 017 comment',
                     'additional': []}),
                "period": 201605,
                "survey_id": "017",
            }
        ...
        survey_019.update(
            {
                "created": str(yesterday),
                "encrypted_data": encrypt_comment(
                    {'ru_ref': '34650525171T', 'boxes_selected': '', 'comment': 'I am a 019 comment',
                     'additional': []}),
                "period": 201605,
                "survey_id": "019",
            }
        ...
        survey_023.update(
            {
                "created": str(yesterday),
                "encrypted_data": encrypt_comment(
                    {'ru_ref': '34650525171T', 'boxes_selected': '', 'comment': 'I am a 023 comment',
                     'additional': []}),
                "period": 201605,
                "survey_id": "023",
            }
        ...
        survey_134.update(
            {
                "created": str(yesterday),
                "encrypted_data": encrypt_comment({"ru_ref": "12346789012A", "boxes_selected": "91w, 95w, 96w, 97w, 91f, 95f, 96f, 97f, 191m, 195m, 196m, 197m, 191w4, 195w4, 196w4, 197w4, 191w5, 195w5, 196w5, 197w5, ", "comment": "flux clean", "additional": [{"qcode": "300w", "comment": "Pipe mania"}, {"qcode": "300f", "comment": "Gas leak"}, {"qcode": "300m", "comment": "copper pipe"}, {"qcode": "300w4", "comment": "solder joint"}, {"qcode": "300w5", "comment": "drill hole"}]}),
                "period": 201605,
                "survey_id": "134",
            }
        )
        ...
        surveys = [survey_009,
                   ...
                   survey_228,
                   survey_283]
        datastore_client.put_multi(surveys)
        print('Successfully put surveys into Datastore')
