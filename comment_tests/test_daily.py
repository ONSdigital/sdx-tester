...
class TestDailyComments(unittest.TestCase):
    ...
    #
    # def test_009(self):
    #     result = pandas.read_excel(f'temp_files/009_daily.xlsx', header=None)
    ...
    #
    # def test_017(self):
    #     result = pandas.read_excel(f'temp_files/017_daily.xlsx', header=None)
    #     self.assertEqual(int(result.iat[2, 1]), 2201)
    ...
    #
    # def test_228(self):
    #     result = pandas.read_excel(f'temp_files/228_daily.xlsx', header=None)
    #     self.assertEqual(int(result.iat[2, 1]), 2201)
